...
//+kubebuilder:rbac:groups=mail.email-sender.com,resources=emailsenderconfigs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=mail.email-sender.com,resources=emailsenderconfigs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=mail.email-sender.com,resources=emailsenderconfigs/finalizers,verbs=update
